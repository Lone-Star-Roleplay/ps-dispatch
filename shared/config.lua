...
Config.Locations = {
    ...
    ["NoDispatchZones"] = {
        [1] = {label = "Ammunation 1", coords = vec3(14.92, -1097.3, 29.8), length = 14.0, width = 14.0, heading = 70, minZ = 27.8, maxZ = 33.8},
        [2] = {label = "Ammunation 2", coords = vector3(821.96, -2163.09, 29.62), length = 14.0, width = 5.0, heading = 270, minZ = 27.62, maxZ = 33.62},
        [3] = {label = "MRPD", coords = vec3(485.58, -1009.92, 30.69), length = 14.0, width = 14.0, heading = 70, minZ = 27.8, maxZ = 35.8},
    },
}
